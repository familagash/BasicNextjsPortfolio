export const tabItems = [
  {
    ...
    date: "December 2019",
    desc: [
      " Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to usingLorem ",
...
export const projects = [
  {
    ...
    class: "flex-row",
    content:
      " There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour,All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet.",
    stack: ["React ", "Sass"],
