...
const TabPanel = ({ id, content, active, desc, date, company }) => {
  return active === id  ? (
    <div className="flex flex-col justify-center mx-5 px-5 ">
      ...
      <ul className="w-full">
        <div className="flex items-center">
          ...
          <li className=" text-justify mt-2 w-3/5">{desc[0]}</li>
        </div>
        <div className="flex items-center ">
          <div className=" w-2/5 justify-center">
            <svg
          ...
          <li className=" text-justify mt-2 w-3/5">{desc[1]}</li>
        </div>
        <div className="flex items-center">
          <div className=" w-2/5 justify-center">
            <svg
          ...
          <li className=" text-justify mt-2 w-3/5">{desc[2]}</li>
        </div>
      </ul>
      <Link href="/about">
